                    ...
                    [
                        ...
                        dbc.Col(
                            dbc.Row(
                                ...
                                className="slect-out-row",
                            ),
                            style={"display": "inline-grid", "width": "300px"},
                        ),
                    ],
                    className="tab_row_all",
                ),
