...
def tab_consistency(consistency_data=CONSISTENCY_DATA):
    ...
    return html.Div([
       ...
       #                             ),
        html.Br(), html.Br(),
        html.P("Design-by-treatment interaction model", style={'font-size': 'medium', 'margin-top': '-0.6%', 'margin-left': '20%'},
    ...
    html.Br(),
    html.Div([ html.Div([html.Button('Export table', id='consistency-export', n_clicks=0, className="btn-export2",
              ...
              html.Div([html.Button('Save all', 'btn-netsplit-all', n_clicks=0,className="btn-export2",
                          style={'padding': '0px 4px 0px 4px','margin-right': '5%',
                                 'margin-bottom': '2px', 'fontSize': 'medium',
              ...
              html.Div([ html.P("Side-splitting model",
                     style={'font-size': 'medium', 'margin-top': '0.8%', 'display': 'inline-block'},
                     className="box__title"),html.Br(),
              html.P("Select edge(s) to display specific comparison(s)",
                     style={'font-size': 'medium', 'margin-top': '-1.2%', 'display': 'inline-block'},
                     className="box__title") ]),
