...
DEFAULT_ELEMENTS = USER_ELEMENTS = get_network_new(df=NET_DATA,pw_df=FOREST_DATA_PRWS ,i=0)
DEFAULT_ELEMENTS2 = USER_ELEMENTS2 = get_network_new(df=NET_DATA2,pw_df=FOREST_DATA_PRWS_OUT2 ,i=1)
