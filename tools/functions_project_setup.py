...
options_effect_size_cont = [
    {"label": "MD", "value": "MD"},
    {"label": "SMD", "value": "SMD"},
]
options_effect_size_bin = [
    {"label": "OR", "value": "OR"},
    {"label": "RR", "value": "RR"},
]
options_outcome_direction = [
...
def __update_options(
    ...
    search_values = (
        [search_value_outcome1, search_value_outcome2]
        if search_value_outcome2 is not None
        else [search_value_outcome1]
    )
    options_var = [
        {"label": "{}".format(col, col), "value": col} for col in data_user.columns
    ]
    ...
    vars_names = [
        [f"{search_value_format}.{c}" for c in col_vars[0]],
...
def __second_options(
    ...
    if search_value_format is None:
        return None, {"display": "none", "justifyContent": "center"}
    if search_value_outcome1 is None:
        return None, {"display": "none", "justifyContent": "center"}
    ...
    return selectors_ef, {"display": "grid", "justifyContent": "center"}
...
def __outcomes_type(number_outcomes, primary_out, noprimary):
    ...
    # print(noprimary)
    if (
        len(primary_out) > 0 and primary_out[0] is not None and len(primary_out[0]) == 2
    ) or (
        len(primary_out) > 0 and noprimary[0] is not None and noprimary[0][0] == "no"
    ):
            ...
            html.Div(
                [
                    dbc.Row(
                        [
                            html.P(
                                f"Select the type of outcome {i + 1}:",
                                className="selcect_title",
                            ),
                            html.Div(
                                [
                        ...
                        [
                            dbc.Col(
                                dbc.Row(
                                    [
                                        html.P(
                                            "Select two outcomes for league table",
                                            className="selcect_title",
                                            style={"text-align": "center"},
                                        ),
                                        dcc.Checklist(
                                            id={"type": "outcomeprimary", "index": "0"},
                                            options=options_outcomes,
                                            className="",
                                            style={
                                                "display": "grid",
                                        ...
                                        dcc.Checklist(
                                            id={"type": "noprimary", "index": "0"},
                                            options=[{"label": "Skip", "value": "no"}],
                                            className="",
                                            style={
                                                "display": "grid",
                                                "color": "green",
...
def __variable_selection(number_outcomes, outcometype, data_format, contents, filename):
    if not outcometype or not all(outcometype):
        return (
            None,
            {"display": "none", "justifyContent": "center"},
            {"display": "none", "justifyContent": "center"},
    ...
    selectors_ef = [
        html.Div(
                ...
                html.Div(
                    [
                        dbc.Row(
                            [
                                html.P(
                                    f"Select effect size for outcome {i + 1}",
                                    className="selcect_title",
                                )
                            ],
                            style={"justifyContent": "center", "display": "grid"},
                ...
                html.Div(
                    [
                        dbc.Row(
                            [
                                html.P(
                                    f"Outcome direction for outcome {i + 1}",
                                    className="selcect_title",
                                )
                            ],
                            style={"justifyContent": "center", "display": "grid"},
                        ...
                        html.Div(
                            [
                                dbc.Row(
                                    [
                                        html.P(
                                            f"Select variables for outcome {i + 1}",
                                            className="selcect_title",
                                        )
                                    ],
                                    style={
                ...
                dbc.Row(
                    [
                        dbc.Button(
                            "Previous",
                            n_clicks=0,
                            id={"type": "outcomeprevious", "index": f"{i}"},
                        ...
                        dbc.Button(
                            "Next",
                            n_clicks=0,
                            id={"type": "outcomebutton", "index": f"{i}"},
                            disabled=True,
                            style={
                                "color": "white",
                                "backgroundColor": "orange",
            ...
            id={"type": "displayvariable", "index": f"{i}"},
        )
        for i in range(number_outcomes)
    ]
                        ...
                        [
                            dbc.Col(
                                dbc.Row(
                                    [
                                        html.P(
                                            "Select potential effect modifiers",
                                            className="selcect_title",
                                            style={"text-align": "center"},
                                        ),
                                        dcc.Checklist(
                                            id="effect_modifier_checkbox",
                                            options=options_var,
                                            className="",
                                            style={
                                                "display": "grid",
