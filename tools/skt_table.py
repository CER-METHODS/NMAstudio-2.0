...
treat_compare_grid = dag.AgGrid(
    ...
    defaultColDef={
        ...
        "resizable": False,
        # Use flex so columns distribute available width and avoid empty space
        "flex": 1,
        "minWidth": 80,
        "wrapText": True,
        # 'autoHeight': True,
    ...
    # Use flex-based column sizing; do not force sizeToFit
    getRowId="params.data.index",
    style={"width": "100%", "height": f"{45.5 * 30}px"},
)
...
modal_fullname_grid = dag.AgGrid(
    ...
    columnSize="autoSize",
    getRowId="params.data.Abbreviation",
    style={
        # "width": "100%",
        #    'height':f'{45.5 *30}px'
    },
